...
\textbf{Peto's paradox-cancer risk saturates with $n$} & Extrinsic & Extrinsic & Intrinsic \\
\bottomrule
\end{tabular}
...
\acknow{The authors acknowledge critical input from Watve lab members, and various faculty members of the Dept of Biology, IISER Pune.}
...
\section*{Supporting Information (SI)}
	...
	\subsection{Non-linear relationship between cancer incidence and cell number}\label{S3 Text}
		...
		\begin{figure}[tbhp]
			\centering
			\includegraphics[width=.8\linewidth]{lin_slopes.png}
		...
		\begin{table*}[tbhp]
			...
			\label{Table S3.2}
			\begin{tabular}[c]{m{0.2\textwidth}m{0.15\textwidth}ccc}
